...
import pe.dante.JavaMail16.util.OAuth2SaslClientFactory;
...
public class OAuth2Authenticator {
	  ...
	  public static final class OAuth2Provider extends Provider {
	    ...
	    public OAuth2Provider() {
	     ...
	     // put("SaslClientFactory.XOAUTH2","com.google.code.samples.oauth2.OAuth2SaslClientFactory");
	      put("SaslClientFactory.XOAUTH2","pe.dante.JavaMail16.util.OAuth2SaslClientFactory");
	   ...
	   */
	    String email = "dartica@gmail.com";
	    String oauthToken = "password";
